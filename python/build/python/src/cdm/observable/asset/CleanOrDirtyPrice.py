...
class CleanOrDirtyPrice(BaseDataClass):
  ...
  """
  cleanPrice: Optional[CleanPrice] = Field(None, description="The clean price and accruals presented separately.")
  """
...
from cdm.observable.asset.CleanPrice import CleanPrice

CleanOrDirtyPrice.update_forward_refs()
