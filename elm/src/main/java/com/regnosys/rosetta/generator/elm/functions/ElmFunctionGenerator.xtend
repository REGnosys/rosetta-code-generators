package com.regnosys.rosetta.generator.elm.functions
...
class ElmFunctionGenerator {
	...
	def Map<String, ? extends CharSequence> generate(String namespace, Iterable<RosettaNamed> rosettaFunctions, String version) {
